...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this, "Hello-word Kotlin ! Hello RePlugin !", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun initData() {
        ...
        // Activity
        // =========
        mItems.add(TestItem("Kotlin Activity-new: Theme BlackNoTitleBar", View.OnClickListener { v ->
