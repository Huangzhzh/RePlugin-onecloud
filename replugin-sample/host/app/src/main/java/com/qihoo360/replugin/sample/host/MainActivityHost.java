 ...
 */
public class MainActivityHost extends Activity {
...
//                RePlugin.startActivity(MainActivity.this, RePlugin.createIntent("com.qihoo360.replugin.sample.demo1", "com.qihoo360.replugin.sample.demo1.MainActivity"));
                ...
                RePlugin.startActivity(MainActivityHost.this, RePlugin.createIntent("com.freerdp.freerdpcore", "com.freerdp.freerdpcore.MainActivity"));
            }
        });
        ...
        findViewById(R.id.btn_start_plugin_for_result).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RePlugin.startActivityForResult(MainActivityHost.this, intent, REQUEST_CODE_DEMO1, null);
            }
        });
        ...
        findViewById(R.id.btn_start_demo3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (RePlugin.isPluginInstalled("demo3")) {
                    RePlugin.startActivity(MainActivityHost.this, RePlugin.createIntent("demo3", "com.qihoo360.replugin.sample.demo3.MainActivity"));
                } else {
                    Toast.makeText(MainActivityHost.this, "You must install demo3 first!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        findViewById(R.id.btn_start_demo4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (RePlugin.isPluginInstalled("webview")) {
                    RePlugin.startActivity(MainActivityHost.this, RePlugin.createIntent("webview", "com.qihoo360.replugin.sample.webview.MainActivity"));
                } else {
                    Toast.makeText(MainActivityHost.this, "You must install webview first!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        findViewById(R.id.btn_install_apk_from_assets).setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                final ProgressDialog pd = ProgressDialog.show(MainActivityHost.this, "Installing...", "Please wait...", true, true);
    ...
    private void simulateInstallExternalPlugin() {
        ...
        if (info != null) {
            RePlugin.startActivity(MainActivityHost.this, RePlugin.createIntent(info.getName(), "com.qihoo360.replugin.sample.demo3.MainActivity"));
        } else {
            Toast.makeText(MainActivityHost.this, "install external plugin failed", Toast.LENGTH_SHORT).show();
        }
    }
